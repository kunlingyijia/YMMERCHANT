...
- (void)_actionCancel{
    ...
    [self.delegate imageCropControlleractionCancel:self];
...
- (UIImage *)_toolbarBackgroundImage{
    ...
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(Width, 54), YES, 0.0);
...
- (void)viewWillLayoutSubviews{
    ...
    self.toolbar.frame = CGRectMake(0, CGRectGetHeight(self.view.frame) - 54, Width, 54);
}
