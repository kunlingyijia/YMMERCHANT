...
- (void)initViews{
    ...
    daterLab=[[UILabel alloc]initWithFrame:Frame(0, 0, daterContentView.w, WH(40))];
    daterLab.text=@"选择日期";
//    daterLab.backgroundColor=MainRedColor;
    daterLab.backgroundColor=[UIColor colorWithHexString:kNavigationBgColor];
    ...
    //cancelBtn.backgroundColor=MainRedColor;
     cancelBtn.backgroundColor=[UIColor colorWithHexString:kNavigationBgColor];
