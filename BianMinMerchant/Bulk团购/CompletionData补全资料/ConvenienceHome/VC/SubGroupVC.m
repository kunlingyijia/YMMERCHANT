...
@interface SubGroupVC ()
@property (weak, nonatomic) IBOutlet UITableView *tableView;

@end

@implementation SubGroupVC
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    RequestCateAndBusinessareaModel * model = self.dataArray[indexPath.row];
    //创建通知通知中心
    [[NSNotificationCenter defaultCenter]postNotificationName:@"SubGroupVC" object:self userInfo:[NSDictionary dictionaryWithObject:[model yy_modelToJSONObject]forKey:@"SubGroupVC"]];
